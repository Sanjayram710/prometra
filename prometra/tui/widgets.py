...
class StatusBar(Static):
    ...
    def render(self) -> RenderableType:
        shortcuts = " [1]Dash [2]Time [3]Repl [4]Srch [5]Diff [6]Comp [7]Anal [8]Help | [Ctrl+P]Cmd | [Ctrl+F]Find | [Ctrl+T]Theme | [Q]Quit"
        status_text = Text()
...
class CommandPaletteModal(ModalScreen[str]):
    ...
    def compose(self):
        with Vertical(id="dialog"):
            ...
            yield Input(placeholder="Type view number (1-8), action, or filter...", id="palette_input")
