...
class GitTracker:
    ...
    def _process_commit(self, commit_hash: str):
        ...
        tags = [
            tag.name for tag in self.repo.tags if tag.commit.hexsha == commit.hexsha
        ]
        ...
        if commit.parents:
            ...
            for d in diffs:
                ...
                if d.b_path and d.b_path not in changed_files:
        ...
        event_info = {
            ...
            "timestamp": datetime.fromtimestamp(commit.committed_date, UTC),
